...
export default function AdminActions({ userId, approved, isBlocked, isAdmin, plan }: Props) {
  ...
  }: { action: Action; label: string; icon: React.ElementType; color: string }) {
